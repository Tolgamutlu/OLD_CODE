...
def read_tracks(music_file)
  ...
  # Put a whil loop here which increments an index to read the tracks
  index = 0
    while index < count
...
def read_track(a_file)
  ...
  # read line one  = a_file.gets
  # read line two
  name = a_file.gets
  location = a_file.gets # finish this
...
def print_tracks(tracks)
  # Use a whil loop with a control variable index
  ...
  while index < tracks.length
    print_track(tracks[index])  # I changed this MM
    index += 1
  end
end
